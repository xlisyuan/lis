...
const projectsData = {
    'giftHelper': { type: "", topic: "角色禮物一覽(手遊小工具)", img: "https://i.imgur.com/PnZb2Sf.png", link: "https://xlisyuan.github.io/flowerNvs_gifts/", info: "<p>手遊角色禮物資訊, 玩家自用網頁.</p><ul> <li>分級顯示名士禮物 <p>左右切換分頁</p> </li> <li>顯示名士頭像 <p>頭像/禮物用spritesheet的方式處理</p> </li> <li>點擊禮物-禮物敘述 <p>為劇情控顯示禮物的描述 點擊其他區域或是滾動關閉</p> </li> <li>名士過濾-顯示選取名士禮物(不分級) <p>只看自己想升級親密度的角色</p> <p>角色選單 可以依據稀有度展開摺疊 </p> </li> <li>名士過濾網址 <p>從網址讀取要顯示的角色 如果有就預先過濾 按鈕複製到剪貼簿</p> </li> <li>禮物獲得方法</li><li>處理手機版面</li><li>使用google analytics觀察使用情形</li></ul>" },
